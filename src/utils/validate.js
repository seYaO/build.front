 ...
 * @param {*} value
 */
export const identityCardValidate = (value) => {
 ...
 * @param {*} value
 */
export const enterpriseNameValidate = (value) => {
    value =value.trim();
    let reg = /^[\u4e00-\u9fa5\sa-zA-Z（）()]{2,}$/;
    if(!value) return false;
 ...
 * @param {*} value
 */
export const passwordValidate20 = (value) => {
 ...
 * @param {*} value
 */
export const flightValidate = (value) => {
    value = value.alltrim();
    const reg = /^([a-zA-z]|\d){5,7}$/;
    return reg.test(value);
}
