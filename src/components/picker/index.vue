...
<div :class="classes" onselectstart="return false;">
    <div :class="cssPrefix + 'picker'" @touchstart="touchStartHandler" @touchmove="touchMoveHandler" @touchend="touchEndHandler" @scroll="scrollHandlder">
        <div :class="cssPrefix + 'picker-scroller'">
            <div v-if="placeholder" :class="[cssPrefix + 'picker-item',cssPrefix + 'picker-placeholder']">
                {{placeholder}}
            </div>
            <div v-for="(item, index) in options" :key="index" :class="[cssPrefix + 'picker-item', item.value === value ? cssPrefix + 'picker-active' : '']" :data-value="item.value" :data-index="index" v-html="item.label"></div>
        </div>
    </div>
