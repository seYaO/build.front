<template>
<layout title="Popup" :showNavbar="false">
    <x-button-group>
        <x-button size="large" type="primary" @click.native="show1 = true">中间弹出</x-button>
        <x-button size="large" type="warning" @click.native="show2 = true">下部弹出</x-button>
        <x-button size="large" type="danger" @click.native="show3 = true">左侧弹出</x-button>
        <x-button size="large" type="danger" @click.native="show4 = true">右侧弹出</x-button>
        <x-button size="large" type="danger" @click.native="show4 = true">右侧弹出</x-button>
        <x-button size="large" type="danger" @click.native="show4 = true">右侧弹出</x-button>
        <x-button size="large" type="danger" @click.native="show4 = true">右侧弹出</x-button>
        <x-button size="large" type="danger" @click.native="show4 = true">右侧弹出</x-button>
    ...
    <popup v-model="show1" position="center" width="90%">
        ...
        <p style="text-align: center;">
            <x-button @click.native="show1 = false">Close Center Popup</x-button>
        </p>
    </popup>
    ...
    <popup v-model="show3" position="left" width="60%">
        <x-button type="danger" style="margin: 20px;" @click.native="show3 = false">Close Left Popup</x-button>
    </popup>

    <popup v-model="show4" position="right" width="50%">
        <x-button type="danger" style="margin: 20px;" @click.native="show4 = false">Close Right Popup</x-button>
    </popup>
</layout>
</template>
...
<script>
import { Layout, Popup, XButton, XButtonGroup } from '@/components'
