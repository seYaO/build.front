...
(function(){
    ...
    var Common = require("/sites/ccrmdemand/common/common"),
        IScroll = require("/modules/iscroll/index"),
        iScroll,
        loc = require("/modules/location/index"),
    ...
    City.prototype = {
        ...
        renderSuggest: function(sugData){
            var self = this,
                Suggest = require("/modules/newsuggest/index"),
