define("pager/0.1.0/index",[],function(require){
    !function ($) {
        ...
        Pagination.prototype = {
            ...
            _drawInner: function () {
                ...
                var tpl = '<ul>' + '<li class="prev' + (self.currentPage - 1 <= 0 ? ' disabled' : ' ') + '"><a href="#" data="' + (self.currentPage - 1) + '">«上一页</a></li>';
                ...
                tpl += '<li class="next' + (self.currentPage + 1 > self.pages ? ' disabled' : ' ') + '"><a href="#" data="' + (self.currentPage + 1) + '">下一页»</a></li>' + '</ul>';
