        ...
        Pagination.prototype = {
            ...
            */
            _drawInner: function () {
                ...
                // 添加首页
                var tpl = '<ul>' + '<li class="first-page' + (self.currentPage - 1 <= 0 ? ' disabled' : ' ') + '"></li>';
                tpl += '<li class="prev' + (self.currentPage - 1 <= 0 ? ' disabled' : ' ') + '"><a href="#" data="' + (self.currentPage - 1) + '"><</a></li>';
                ...
                tpl += '<li class="next' + (self.currentPage + 1 > self.pages ? ' disabled' : ' ') + '"><a href="#" data="' + (self.currentPage + 1) + '">></a></li>';
            ...
            _drawCtrl: function () {
                var tpl = '<div>&nbsp;'  +
                    '<span>' + '&nbsp;跳转到&nbsp;' + '<input type="text" class="page-num"/><button class="page-confirm">GO</button>' + '&nbsp;' + '</span>' + '</div>';
                return tpl;
            },
