define('intellsearch/0.2.0/history', ['intellsearch/0.2.0/searchBase', 'common/0.1.0/storage', 'intellSearch/0.2.0/tmpl/history'], function (require, exports, module) {
    var storage = require("common/0.1.0/storage");
    var SearchBase = require("intellsearch/0.2.0/searchBase"),
        historyTmpl = require('intellSearch/0.2.0/tmpl/history');
    ...
    var history = SearchBase.extend({
      ...
      */
        ...
        _save: function (key, value) {
            if (key.match(/<>'"/) || value.match(/<>'"/)) return;
            var list = this._getDatalist(),
