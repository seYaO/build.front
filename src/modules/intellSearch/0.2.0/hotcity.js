define('intellsearch/0.2.0/hotcity', ['intellsearch/0.2.0/searchBase', 'intellSearch/0.2.0/tmpl/hotcity'], function (require, exports, module) {
    var SearchBase = require("intellsearch/0.2.0/searchBase"),
        hotcityTmpl = require('intellSearch/0.2.0/tmpl/hotcity');
