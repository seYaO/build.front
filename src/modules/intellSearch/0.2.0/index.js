 ...
 */
/* global $ */
define("intellSearch/0.2.0/index", ["intellsearch/0.2.0/search", "intellsearch/0.2.0/intellsearch", "intellsearch/0.2.0/history",
    "intellsearch/0.2.0/track", 'intellsearch/0.2.0/hotcity', 'intellSearch/0.2.0/search-label', "departure/0.2.0/index"], function (require) {
    var Search = require("intellsearch/0.2.0/search"),
        intellSearch = require("intellsearch/0.2.0/intellsearch"),
        history = require("intellsearch/0.2.0/history"),
        track = require("intellsearch/0.2.0/track"),
        hotcity = require("intellsearch/0.2.0/hotcity"),
        searchLabel = require("intellSearch/0.2.0/search-label"),
