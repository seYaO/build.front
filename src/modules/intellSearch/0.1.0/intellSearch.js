define('intellsearch/0.1.0/intellsearch', ['intellsearch/0.1.0/searchBase', 'intellSearch/0.1.0/tmpl/intellSearch', 'intellsearch/0.1.0/intellSearch.css'], function (require, exports, module) {
    /*
    ...
    var jsonDB = require("intellsearch/0.1.0/jsonDB");
        intellTmpl = require('intellSearch/0.1.0/tmpl/intellSearch')
    ...
    var intellSearch = SearchBase.extend({
        ...
        _setTrackData: function (json) {
            ...
            self.o_pobj.setTrackData("selectindex", i);
