define('intellSearch/0.2.1/search', ['base/0.1.0/base', './views/search.dot','jsondb/0.1.0/dbstorage'], function (require, exports, module) {
    var searchTmpl = require('./views/search.dot');
