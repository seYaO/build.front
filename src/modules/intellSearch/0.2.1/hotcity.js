define('intellSearch/0.2.1/hotcity', ['intellSearch/0.2.1/searchBase', './views/hotcity.dot'], function (require, exports, module) {
    var SearchBase = require("intellSearch/0.2.1/searchBase"),
        hotcityTmpl = require('./views/hotcity.dot');
