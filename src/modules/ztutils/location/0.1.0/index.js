...
!function (factory) {
    ...
    Location.prototype = {
        ...
        config: {
            ...
            tmplTip: function(it) {
                var out='<div id="J_AddressTip" class="address-tip"> <div> <p>我们发现你目前位置在 <span>'+(it.city)+'</span></p><p>';if(it.AreaName){out+=' 属于 <span>'+(it.AreaName)+' ';}out+=' </span>是否切换</p> <a class="J_CancelBtn" href="javascript:void(0);">取消</a> <a class="J_ConfirmBtn" href="javascript:void(0);">确定</a> </div></div>';return out;
            },
            timeout: 5000,
            expire: 3600 * 1000,
            type : 0,
