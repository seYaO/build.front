    ...
    (function($, window, document, undefined) {
        ...
        $.fn.lazyload = function(options) {
            ...
            $container.on("addElements",function(){
                var args = arguments;
                elements = $(Array.prototype.slice.call(args,1));
                bindEvent(elements);
                update();
            });
                        ...
                        if (!this.loaded) {
                            ...
                            $("<img />")
                                ...
                                .on("load complete", function() {
                                    (function($self){
                                        $self.hide().attr({src:($self.data(settings.data_attribute).replace("http:",""))})
                                            .css(settings.css);
                                        if(settings.effect){
                                ...
                                .attr("src",$self.data(settings.data_attribute) ? $self.data(settings.data_attribute).replace("http:","") : "");
                        }
                    });
...
"function" === typeof define ? define("lazyload/0.1.0/index",[],function(){return main(jQuery);}) : main(jQuery);
