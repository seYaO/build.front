...
;(function(){
    ...
    Class.extend = function(prop) {
        ...
        // Instantiate a base class (but only cre ate the instance,
        ...
        function SubClass() {
            ...
            if (!this.initialize && window.SearchFrom) {
               return new window.SearchFrom(arguments);
            }
...
define('base/0.2.0/base', [], function (require, exports, module) {
    var Base;
    /*
     CusEvent
     */
    ...
    function _decorator(name){
        ...
        this[name] = function(){
            ...
            _arguments.unshift(name + ":before");
            if (this.trigger.apply(this, _arguments) === false) {
                return;
            }
            result = method.apply(this, arguments);

            _arguments[0] = name + ":after";
            this.trigger.apply(this, _arguments);
            return result;
        };
