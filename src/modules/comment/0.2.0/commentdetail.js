...
define("commentdetail", ["tmpl/pc/sinProduct/commetLi"], function (require, exports, module) {
    ...
    var Details = {
        init: function () {
            ...
            //评论模块初始化
            //Details.sinComet.init();
            Details.showBigImg();
            Details.foldAndUnfold();
        },
        ...
        showBigImg : function () {
            $(".comm-img img").on("mouseover", function () {
                ...
                var L = $(this),
                    ...
                    imgurl = Details.setImageSize(L.attr("src"),"640x360"),
        ...
        sinComet:{
                    ...
                    fish.one("#J_cometPage").mPage({
                        ...
                        callback: function (data, num) {
                            if (data) {//有数据
                                ...
                                this.build(_pagenum);
                                Details.sinComet.creatComList(data);
                                //IE8渲染触发
            ...
            eventsBind: function () {
                ...
                fish.all("#J_cometType span").on("click", function () {
                    Details.sinComet.typeCate = fish.one(this).attr("comtid");
                    fish.one(this).addClass("on_bg").sibling(true).removeClass("on_bg");
                    Details.sinComet.paging();
                });
            },
            init: function () {
                this.creatBones();
