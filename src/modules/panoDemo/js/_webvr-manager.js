(function(f) {
    ...
    return (function e(t, n, r) {
        ...
        }, { "./emitter.js": 2, "./modes.js": 3, "./util.js": 4 }],
        ...
        5: [function(_dereq_, module, exports) {
            ...
            function WebVRManager(renderer, effect, params) {
                ...
                // 存储rendderer和effect参数
                this.renderer = renderer;
                this.effect = effect;
                var polyfillWrapper = document.querySelector('.webvr-polyfill-fullscreen-wrapper');
                this.button = new ButtonManager(polyfillWrapper); //获取buttonManager对象，初始包括icon图标

                this.isFullscreenDisabled = !!Util.getQueryParameter('no_fullscreen'); //获取地址栏参数
                this.startMode = Modes.NORMAL; //默认1
                ...
                this.getDeviceByType_(VRDisplay).then(function(hmd) {
                    ...
                    switch (this.startMode) {
                        case Modes.MAGIC_WINDOW:
                            this.setMode_(Modes.MAGIC_WINDOW); //2
                            break;
                        case Modes.VR:
                            this.enterVRMode_();
                            this.setMode_(Modes.VR); //3
                            break;
                        default:
                            this.setMode_(Modes.NORMAL); //1
                    }
                ...
                // 绑定fs和vr两个callback到this.button.callbacks中
            ...
            WebVRManager.prototype.setMode_ = function(mode) { //1
                var oldMode = this.mode; //0
                if (mode == this.mode) { //0
        ...
        }, { "./button-manager.js": 1, "./emitter.js": 2, "./modes.js": 3, "./util.js": 4 }]
    }, {}, [5])(5)
});