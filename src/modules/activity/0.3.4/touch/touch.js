...
(function ($) {
    window.tcApp = {
        ...
        getPassParam: function () {
            var url = location.href,
                params = tcApp.passParams || ["moduleid", "refid", "channelId", "jobNumber", "tcnatag",'sharetag'],
                paramArr = [],
                paramStr = '',
                reg, hasParam;
            //
    ...
    window.Activity = {
        cfg: {
            ...
            urlTmpl: "{host}/dujia/AjaxHelper/activityHandler.ashx?type=ACTRESOURCE&actid={activityId}&pid={cycleId}&readnew=1",
            mockData: null,
            ...
            serverTimeUrl: document.location.protocol + '//www.ly.com/dujia/AjaxCall.aspx?Type=GetFocusValue',
            //是否跳微信站
            needJumpWX: false,
            memberId: "tcwvmid",
        ...
        tmplProAttr: function (data) {
            ...
            var str = 'href="javascript:void(0)"' +
                ' data-url="//m.ly.com/dujia/tours/' + data.LineId + '.html?actType=' + data.RedirectKey + (tcApp.getPassParam()) + '"' +
