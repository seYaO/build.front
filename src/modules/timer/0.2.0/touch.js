 ...
 * });
 */
 // 注意：如果需求要求小时数显示天数*24小时，则hour=fullhours
(function($){
            ...
            self.timered(function(){
                ...
                if(diff>0){
                    ...
                    if(self.lastIndex!==index){
                        ...
                        ret = _cfg.callback && _cfg.callback.call(self,el,ind,_cfg);
    ...
    Timer._pushRepeatDate = function(param,arr,repeatIndex,now){
        ...
        if(now >= arr[repeatIndex+1]){
            ...
            for(var i = 0; i <=2; i++){
                ...
                var _date = repeatStartDate.getDate();
                repeatStartDate.setDate(_date+1);
            }
            //需要替换的位置
            var _replaceArr = [1,1];
