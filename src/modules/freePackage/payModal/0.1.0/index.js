define("freePackage/payModal/0.1.0/index",["tmpl/pc/order/payModal","freePackage/payModal/0.1.0/index.css"],function(require,exports,module){
        ...
        usualEvent : function(){
            ...
            $("#J_pay_sub").on("click",function(){
                ...
                if((!self.isSubimit) && subCheck){
                    ...
                    seajs.use("dialog/0.2.0/dialog", function (require) {
                        var $dialog1 = new require({
                                skin: "ErrorTips"
                            });
                        var config = {
                            type: 'html',
                            ...
                            quickClose: false,
                            height: '205px',
                            content:'<div class="error-warning1 fixed-warn1"><div class="data-loading"><div class="bg"></div><span>努力加载中，请稍候...</span></div></div>'
                        };
