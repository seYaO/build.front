define("freePackage/pager/0.2.1/index",[],function(){
    ...
    **/
    ...
    Page.prototype.buildUrl = function (url) {
        ...
        return url ="/dujia/AjaxHelper/DynamicPackageAjax.ashx?Type=FLIGHTLIST&param="+encodeURIComponent(url);
    }

    Page.prototype.buildAjaxObj = function () {
        if (this.ajaxObj.data) {
            this.ajaxObj.data.Basic.PageIndex = this.current;
        } else {
    ...
    function init() {
        var that = this;
        $("#J_CometPager li").on("click", "a", function (e) {
            var elem = $(e.target);
