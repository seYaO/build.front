define("freePackage/calendar/0.2.0/comcal",["common/0.1.0/ua"],function(require,exports,module){
    var $ = jQuery,
...
// 定位增强
        ...
        function buildTabs(cfg){
            ...
            html += '</ul></div><a onselectstart="return false;" style="-moz-user-select:none;" class="prev J_PreviousMonth"><span></span></a><a class="next J_NextMonth" onselectstart="return false;" style="-moz-user-select:none;"><span></span></a></div>';
            return html;
        }
        function tabExtraBuild(isNewTab){
            ...
            if(isNewTab){
                ...
                htmlStr ='<div class="month-nav">' +
                    '<a href="javascript:;" hidefocus="true" class="previous-month J_PreviousMonth"></a>' +
            ...
            $(this.panel).on("click", function(e) {
                ...
                while (target !== this) {
                    ...
                    if (target[0].tagName.toLowerCase() === "td") {
                        ...
                        break;
                    } else if (target.hasClass("J_PreviousMonth")) {
            ...
            $(this.yearPanel).on("click", function(e) {
                ...
                while (elem !== this) {
                    ...
                    if (tagName === "a") {
                        ...
                        if ($(elem).hasClass("J_PreviousMonth")) {
