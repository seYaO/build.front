define("freePackage/calendar/0.2.0/discount",["tmpl/pc/newdetails/calDiscount"],function(require,exports,module){
    var calDiscountTmpl = require("tmpl/pc/newdetails/calDiscount"),
        $ = jQuery;
    var inst;
    ...
    Discount.prototype = {
        ...
        ak: "",
        lineid: "",
        url: "/dujia/AjaxHelper/ToursHandler.ashx?action=GETPREFERENTIDATEIST",
        host: window.host||"",
        init: function(cfg){
            var self = this,
                cal = cfg.calendar,
