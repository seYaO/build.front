(function (_module) {
    if (typeof (define) != "undefined" && define.amd) {
        define(["datepicker/0.2.1/datepicker", "datepicker/0.2.1/tmpl/calendar-group", "datepicker/0.2.1/tmpl/datepicker", "css!datepicker/0.2.1/theme/calendar-group"], function (DatePicker, calendarTmpl, simpleTmpl) {
            return _module(DatePicker, calendarTmpl, simpleTmpl);
        });
    }
    else if (typeof (define) != "undefined" && define.cmd) {
        define("datepicker/0.2.1/calendar-group", ["datepicker/0.2.1/datepicker", "datepicker/0.2.1/tmpl/calendar-group", "datepicker/0.2.1/tmpl/datepicker", "datepicker/0.2.1/theme/calendar-group.css"], function (require, exports, module) {
            var DatePicker = require("datepicker/0.2.1/datepicker"),
                calendarTmpl = require('./tmpl/calendar-group.dot');
            var simpleTmpl = require('./tmpl/datepicker.dot');
            return _module(DatePicker, calendarTmpl, simpleTmpl);
        });
    }
    else {
