(function (_module) {
    if (typeof (define) != "undefined" && define.amd) {
        define(['popup/0.2.0/popup', "datepicker/0.2.1/calendar-year", "datepicker/0.2.1/calendar-month"], function (Popup, YearPanel,MonthPanel) {
            return _module(Popup, YearPanel,MonthPanel);
        });
    }
    else if (typeof (define) != "undefined" && define.cmd) {
        define("datepicker/0.2.1/calendar-monthyear", ['popup/0.2.0/popup', "datepicker/0.2.1/calendar-year", "datepicker/0.2.1/calendar-month"], function (require, exports, module) {
            var Popup = require('popup/0.2.0/popup'),
                YearPanel = require('datepicker/0.2.1/calendar-year');
            var MonthPanel = require("datepicker/0.2.1/calendar-month");
            return _module(Popup, YearPanel, MonthPanel);
        });
    }
    else {
