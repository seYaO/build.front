(function (_module) {
    if (typeof (define) != "undefined" && define.amd) {
        define(["datepicker/0.2.1/datepicker", "datepicker/0.2.1/tmpl/calendar-edit", "css!datepicker/0.2.1/theme/calendar-edit"], function (DatePicker, calendartmpl) {
            return _module(DatePicker, calendartmpl);
        });
    }
    else if (typeof (define) != "undefined" && define.cmd) {
        define("datepicker/0.2.1/calendar-edit", ["datepicker/0.2.1/datepicker", "datepicker/0.2.1/tmpl/calendar-edit", "datepicker/0.2.1/theme/calendar-edit.css"], function (require, exports, module) {
            var DatePicker = require("datepicker/0.2.1/datepicker"),
                calendartmpl = require("./tmpl/calendar-edit.dot");
            return _module(DatePicker, calendartmpl);
        });
    }
    else {
