define("datePicker/0.2.0/index", ["datePicker/0.2.0/datePicker", "datePicker/0.2.0/tmpl/calendar4price", "datePicker/0.2.0/theme/price.css"], function (require) {
    var DatePicker = require("datePicker/0.2.0/datePicker"),
        calendarTmpl = require("datePicker/0.2.0/tmpl/calendar4price"),
