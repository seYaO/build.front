...
define("common/0.1.0/ua",[],function (require, exports, module) {
    /**
     * @module common/0.1.0/ua
     */
    'use strict';
     ...
     * @desc 获取ie的版本
     * @example
     * //chrome的版本 返回 undefined
     * //如果是ie,则返回 ie版本号
     * @returns {*}
     */
    exports.ie = function(){
        var browser = this.browser();
        if(browser.name && browser.name.toUpperCase() === "IE"){
