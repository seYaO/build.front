 ...
 */
define("departure/0.2.0/index", ["departure/0.2.0/cityInfoLists"], function (require, exports, module) {
    require("departure/0.2.0/cityInfoLists");
    var cityInfo = {}, $ = jQuery;
    var strTmpl = '<b id="city_select" class="city_b" data-scid={cityId} ><strong>{cityName}</strong><i></i></b><div id="popleave" class="none"  test=""> <div class="leavecity"></div></div>';
    ...
    Departure.prototype = {
        ...
        clickEvent:function(){
            ...
            panel.on("mouseenter",function(e){
                if(!$.contains(tips[0],e.target)) {
                    $(".city_b").addClass("city_b_enter");
                    $(".leavecity").addClass("leavecity-enter");
                    $("#popleave").toggle();
            ...
            panel.on("mouseleave",function(e){
                if(!$.contains(tips[0],e.target)) {
                    $(".city_b").removeClass("city_b_enter");
            ...
            doc.on("click",function(e){
                if(!$.contains(panel[0],e.target)){
                    $("#popleave").hide();
                    $(".city_b").removeClass("city_b_enter city_b_hover");
                }
            });
        ...
        startCities: function () {
            var url = "//www.ly.com/dujia/AjaxActivity.aspx?type=QueryIndexTotalCity";
            var param = {
                "lineType": "0,1"
            };
            var obj,self=this;
