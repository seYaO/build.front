...
(function (_module) {
    if (typeof define != "undefined" && define.amd) {
        define(["base/0.2.0/module", "popup/0.3.2/popup", "css!popup/0.3.2/popup"], _module);
    } else if (typeof define != "undefined" && define.cmd) {
        define("popup/0.3.2/popup", ["base/0.2.0/module", "popup/0.3.2/popup", "popup/0.3.2/popup.css"], function (require, exports, module) {
    ...
    var Popup = Module.extend({
        ...
        __render: function __render(conf, res) {
            ...
            if (conf.hidebutton) {
                self.o_wrapper.find(".module-dialog").hide();
