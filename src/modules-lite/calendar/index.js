 ...
 * @example
 * //加载日历模块
 * var Calendar = require("wanleTouch/common/calendar/index");
 * Calendar.init({
 *     date: "2014-10-18",
...
/* global Monitor */
(function(){
    var calendar = require("/modules-lite/calendar/cal"),
     ...
     * @returns {*}
     */
    calendar.getAjaxObj = function(url){
        var self = this;
        if(!url) {
            return null;
        }
