...
var app = new Vue({
    ...
    methods: {
        ...
        getLink: function (sceneryId, wurl, murl, index) {
            ...
            if (this.isTc) {
                alert('tctclient://scenery/detail?sceneryId=' + sceneryId + '&wvc1=1&wvc2=1&tcwebtag=v300v' + spm + 'v&refid=508528687')
                // return 'tctclient://scenery/detail?sceneryId=' + sceneryId + '&wvc1=1&wvc2=1&tcwebtag=v300v' + spm + 'v' + this.addHtml
                return 'tctclient://scenery/detail?sceneryId=' + sceneryId + '&wvc1=1&wvc2=1&tcwebtag=v300v' + spm + 'v&refid=508528687'
